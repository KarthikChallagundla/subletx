  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ color: '#2563eb', marginBottom: 16, fontWeight: 900, fontSize: '2rem', letterSpacing: '-1px' }}>Payment Instructions</h2>
        <div style={{ marginBottom: 16, color: '#334155', fontSize: 16 }}>
        ...
        <div style={{ marginBottom: 18 }}>
          <div style={{ fontWeight: 600, marginBottom: 6, color: '#2563eb' }}>Pay via UPI/QR</div>
          {upiId ? (
            <>
              <div style={{ background: '#f3f4f6', borderRadius: 10, padding: 14, marginBottom: 8 }}>
                <div style={{ color: '#1e293b' }}>UPI ID: <b>{upiId}</b></div>
                <div style={{ marginTop: 10, marginBottom: 6 }}>
                  <img src={`https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=upi://pay?pa=${upiId}&am=${upiAmount}`} alt="UPI QR" />
                </div>
                <a
                  href={upiUrl}
                  style={{ display: 'block', margin: '10px 0', color: '#2563eb', fontWeight: 600 }}
                >
                ...
                <button
                  ...
                  style={{ background: 'none', border: 'none', color: '#2563eb', textDecoration: 'underline', cursor: 'pointer', marginTop: 4, fontWeight: 600 }}
                >
            ...
            <div style={{ color: 'red', fontWeight: 500 }}>Seller has not set a UPI ID.</div>
          )}
          <div style={{ fontSize: 14, color: '#64748b', marginTop: 10 }}>
            <label htmlFor="transactionId" style={{ display: 'block', marginBottom: 6, color: '#1e293b', fontWeight: 600 }}>
            ...
            <input
              ...
              required
              style={{ width: '100%', padding: 10, fontSize: 16, borderRadius: 10, border: '1.5px solid #c7d2fe', marginBottom: 8, background: '#f8fafc', transition: 'border 0.2s', color: '#111' }}
              disabled={booked || loading}
            />
            <label htmlFor="screenshot" style={{ display: 'block', marginBottom: 6, color: '#1e293b', fontWeight: 600 }}>
        ...
        {bookingSuccess && (
          <div style={{ color: bookingSuccess.startsWith('Booking') ? 'green' : 'red', marginBottom: 10, fontWeight: 500 }}>{bookingSuccess}</div>
        )}
